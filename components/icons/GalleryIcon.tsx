...
/** Matches `assets/images/icons/gallery.svg` — `color` is the path fill (SVG used black). */
export function GalleryIcon({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G opacity={0.3}>
        <Path
          d="M2.5798 19.0103L2.5598 19.0303C2.2898 18.4403 2.1198 17.7703 2.0498 17.0303C2.1198 17.7603 2.3098 18.4203 2.5798 19.0103Z"
          fill={color}
        />
        <Path
