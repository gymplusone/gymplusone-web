...
/** Matches `assets/images/icons/weight.svg` — dumbbell / lifter badge. */
export function WeightIcon({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      {variant === "filled" ? (
        <>
          <Rect x={1.75} y={8.25} width={1.75} height={7.5} rx={0.875} fill={color} />
          <Rect x={20.5} y={8.25} width={1.75} height={7.5} rx={0.875} fill={color} />
          <Rect x={3.8} y={6.25} width={4.6} height={11.5} rx={2.3} fill={color} />
          <Rect x={15.6} y={6.25} width={4.6} height={11.5} rx={2.3} fill={color} />
          <Rect x={8.1} y={11.05} width={7.8} height={1.9} rx={0.95} fill={color} />
        </>
      ) : (
        <>
          <Path
